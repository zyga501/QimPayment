...
-(void)btton:(UIButton*)btn
{
    ...
    NSMutableURLRequest *rever1 = [PostAsynClass postAsynWithURL:url1 andInterface:url17 andKeyArr:@[@"merId",@"liqCardId",@"liqAmt",@"transPwd",@"clientModel"]andValueArr:@[user.merid,user.kaBian,text1,[MyMD5 md5:_secrect.text],[[UIDevice currentDevice] model]]];
    //
