...
import cn.qmpos.scanning.RGBLuminanceSource;
import cn.qmpos.scanning.ViewfinderView;
...
public class ScanningActivity extends BaseActivity implements Callback,
	...
	private ImageView result_bitmap_iv;
	...
	private void initView() {
		...
		function_btn = (Button) findViewById(R.id.function_btn);
		result_bitmap_iv = (ImageView) findViewById(R.id.result_bitmap_iv);
		hasSurface = false;
...
//		showToast(resultString);
		Intent intent = new Intent(this, ScanAfterPaymentActivity.class);
		intent.putExtra("Values", resultString);
		startActivity(intent);
		this.finish();
		System.out.println("Values=" + resultString);
