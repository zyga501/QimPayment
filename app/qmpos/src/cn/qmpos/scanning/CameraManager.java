...
public final class CameraManager {
	...
	public Rect getFramingRect() {
		...
		if (framingRect == null) {
			...
			int width = screenResolution.x * 3 / 5;// lv.ly 2015.6.1
			...
			int height = screenResolution.y * 3 / 5;// lv.ly 2015.6.1
			...
			int topOffset = (screenResolution.y - height) / 4;// lv.ly 2015.6.1
