...
public class ModifyTransPwdActivity extends BaseActivity implements
		OnClickListener {
	...
	private void init() {
		btnBack = (Button) this.findViewById(R.id.modify_trans_pwd_btn_back);
		btnSubmit = (Button) this
				.findViewById(R.id.modify_trans_pwd_btn_submit);
		btnBack.setOnClickListener(this);
		btnSubmit.setOnClickListener(this);

		editNowPwd = (EditText) this
				.findViewById(R.id.modify_trans_pwd_now_pwd);
		editNewPwd = (EditText) this
				.findViewById(R.id.modify_trans_pwd_new_pwd);
		editAgainPwd = (EditText) this
				.findViewById(R.id.modify_trans_pwd_again_pwd);

		modifyTransPwdActivity = this;
	}

	public void onClick(View v) {
		try {
			switch (v.getId()) {
			case R.id.modify_trans_pwd_btn_back:
				finish();
				break;
			case R.id.modify_trans_pwd_btn_submit:
				submit();
				break;
			}
		} catch (Exception e) {
	...
	class ModifyLoginPwdTask extends
		...
		protected void onPostExecute(HashMap<String, String> resultMap) {
			...
			if (!Constants.SERVER_SUCC.equals(respCode)) {
				dialog.hide();
				Toast.makeText(modifyTransPwdActivity, respDesc,
				...
				builder.setPositiveButton("确认",
						new DialogInterface.OnClickListener() {
							public void onClick(DialogInterface dialog,
									int which) {
								Intent i = new Intent(modifyTransPwdActivity,
										MainActivity.class);
								modifyTransPwdActivity.startActivity(i);
							}
						});
				builder.show();
			} catch (Exception e) {
