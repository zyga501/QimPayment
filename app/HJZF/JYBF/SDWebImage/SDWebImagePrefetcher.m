...
- (void)reportStatus
{
    ...
    NSLog(@"Finished prefetching (%lud successful, %ld skipped, timeElasped %.2f)", total - _skippedCount, (unsigned long)_skippedCount, CFAbsoluteTimeGetCurrent() - _startedTime);
}
