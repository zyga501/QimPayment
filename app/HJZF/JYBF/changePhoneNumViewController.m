...
-(void)makeNav
{
    ...
    [mnb createMyNavigationBarWithBgImageName:nil andLeftBBIIamgeNames:[NSArray arrayWithObject:@"title_back.png"] andRightBBIImages:nil andTitle:@"更换手机号" andClass:self andSEL:@selector(bacClick:)];
...
-(void)makeUI
{
    ...
    button.backgroundColor=[UIColor colorWithRed:56/255.0 green:58/255.0 blue:77/255.0 alpha:1];
